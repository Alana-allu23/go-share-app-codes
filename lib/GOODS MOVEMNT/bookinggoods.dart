...
class bookinggoods extends StatefulWidget {
  const bookinggoods({super.key});

  @override
  State<bookinggoods> createState() => _bookinggoodsState();
}

class _bookinggoodsState extends State<bookinggoods> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('booking goods movement'),
